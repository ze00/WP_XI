...
namespace Lawn_Android
{
    internal static class SaveStateTransferHelper
    {
        ...
        public static void OnTransfer(XIActivity activity, OldSaveStateType type)
        {
            ...
            void DoConfirmTranferDialog(XIActivity activity, OldSaveStateType type, OldSaveStateType selection, int selectedNumber, List<bool> result, EventWaitHandle waitHandle)
            {
